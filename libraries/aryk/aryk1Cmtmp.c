...
void aryk1Cmtmp( const char *type, int ndim, const hdsdim *dim, HDSLoc **loc,
...
*  Synopsis:
*     void aryk1Cmtmp( const char *type, int ndim, const hdsdim *dim,
