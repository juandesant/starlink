...
void aryk1Dcre( int defer, const char *type, int cmplx, int ndim,
...
/* Local variables: */
   ...
   hdsdim dim[ARYK__MXDIM];    /* Dimension sizes of array components */
...
/* Call error tracing routine and exit. */
   if( *status != SAI__OK ) aryk1Trace( "aryk1Dcre", status );
