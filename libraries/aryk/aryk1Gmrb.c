...
void aryk1Gmrb( AryACB *acb, int *mtrex, int *mrfull, int *whole,
               hdsdim lmrb[ ARYK__MXDIM ], hdsdim umrb[ ARYK__MXDIM ],
               hdsdim lmtr[ ARYK__MXDIM ], hdsdim umtr[ ARYK__MXDIM ], int *status ) {
/*
*+
*  Name:
*     aryk1Gmrb
...
*     void aryk1Gmrb( AryACB *acb, int *mtrex, int *mrfull, int *whole,
*                    hdsdim lmrb[ ARYK__MXDIM ], hdsdim umrb[ ARYK__MXDIM ],
*                    hdsdim lmtr[ ARYK__MXDIM ], hdsdim umtr[ ARYK__MXDIM ],
*                    int *status )
...
/* Call error tracing routine and exit. */
   if( *status != SAI__OK ) aryk1Trace( "aryk1Gmrb", status );
