...
void aryk1Nel( int ndim, const hdsdim *lbnd, const hdsdim *ubnd, size_t *el,
              int *status ) {
/*
*+
*  Name:
...
*  Synopsis:
*     void aryk1Nel( int ndim, const hdsdim *lbnd, const hdsdim *ubnd,
...
/* Call error tracing routine and exit. */
   if( *status != SAI__OK ) aryk1Trace( "aryk1Nel", status );
