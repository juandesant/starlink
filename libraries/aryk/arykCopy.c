...
*     place
*        An array placeholder (e.g. generated by the arykPlace function)
...
/* Make a copy of the array. */
         aryk1Cpy( acb1, pcb->tmp, pcb->loc, 1, &acb2, status );
...
/* Report context information and call the error tracing routine if
   appropriate. */
         ...
         errRep( " ", "arykCopy: Error making a copy of an array.", status );
         aryk1Trace( "arykCopy", status );
      }
   } else {
      *status = tstat;
   }
