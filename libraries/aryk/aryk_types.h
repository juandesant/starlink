#if !defined( ARYK_TYPES_INCLUDED )   /* Protect against multiple inclusion*/
#define ARYK_TYPES_INCLUDED 1
...
*  Purpose:
*     Defines public data types and constants used by ARYK.

*  Description:
*     This file defines all the public data types and constants
*     used within the C version of ARYK.
